...
export default function VisionSection() {
  return (
    <section
      ...
      className="bg-white py-32 text-gray-900"
    >
      <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          BeMalo adalah jasa pembuatan website profesional yang berfokus pada
          kualitas dan hasil nyata. Kami membantu bisnis di seluruh Indonesia
          untuk berkembang melalui solusi digital yang inovatif. Dari jasa
          desain web hingga web development, kami siap menjadi partner digital
        ...
        >
          <div className="p-6 border rounded-lg">
            ...
            <p className="text-gray-600">
              Bikin website yang cepat, aman, dan SEO-friendly untuk bisnis Anda
            </p>
          </div>
          <div className="p-6 border rounded-lg">
            <h3 className="mb-2 font-semibold text-lg">Desain Modern</h3>
            <p className="text-gray-600">
              Jasa desain web responsif yang menarik di semua perangkat
            </p>
          </div>
          <div className="p-6 border rounded-lg">
            <h3 className="mb-2 font-semibold text-lg">Support 24/7</h3>
            <p className="text-gray-600">
              Layanan support dan maintenance website yang responsif
            </p>
          </div>
        </motion.div>
      </div>
